...
export class SolicitudesService {
  ...
  private normalizeSolicitud(s: any): any {
    ...
    return {
      ...
      Codigo_informe_resultados: s?.Codigo_informe_resultados ?? null,
  ...
  async createSolicitud(body: any): Promise<void> {
    ...
    if (!res.ok) {
      ...
      const optimisticRaw = {
        ...
        Codigo_informe_resultados: null,
    ...
    try {
      ...
      const next = current.map((s) => {
        ...
        const merged = {
          ...
          Codigo_informe_resultados: body?.Codigo_informe_resultados ?? s?.Codigo_informe_resultados ?? null,
